...
File data;
SdFat sd;
#define BITRATE 500000 // make sure the bitrate of the transmitter is the same as the reciever
...
void setup()
{
    ...
    int canSSOffset = 0;
    while (CAN.begin(MCP_STD, CAN_500KBPS, MCP_16MHZ) != CAN_OK)
    {
    ...
    CAN0.init_Filt(0, 0, 0x620);
    
    CAN0.init_Mask(1, 0, 0x7F4);
